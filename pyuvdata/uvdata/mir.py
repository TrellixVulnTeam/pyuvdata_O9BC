...
class Mir(UVData):
    ...
    def _init_from_mir_parser(
        ...
        self.phase_center_ra = 0.0  # This is ignored w/ multi-phase-ctr data sets
        self.phase_center_dec = 0.0  # This is ignored w/ multi-phase-ctr data sets
        self.phase_center_epoch = 2000.0  # This is ignored w/ multi-phase-ctr data sets
